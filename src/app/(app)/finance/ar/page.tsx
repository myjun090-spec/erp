...
export default function ArInvoicesPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try { const res = await fetch(appendProjectIdToPath("/api/finance", currentProjectId)); const json = await res.json(); if (json.ok) setItems(json.data.arInvoices); else setError(json.message); } catch { setError("네트워크 오류"); } finally { setLoading(false); }
  }, [currentProjectId]);
